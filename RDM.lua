...
function init_gear_sets()
    ...
    sets.precast.Waltz = {ammo="Brigantia Pebble",
		head="Vitivation Chapeau +1",neck="Unmoving Collar",ear1="Roundel Earring",ear2="Soil Pearl",
		body="Vitivation Tabard +1",hands="Vitivation Gloves +1",ring1="Titan Ring",ring2="Titan Ring",
		back="Iximulew Cape",waist="Chuq'aba Belt",legs="Vitivation Tights +1",feet="Vitivation Boots +1"}
    ...
    sets.precast.FC = {ammo="Impatiens",
		head="Atrophy Chapeau +1",neck="Jeweled Collar",ear2="Loquacious Earring",ear1="Estq. Earring",
		body="Vitivation Tabard +1",hands="Gende. Gages +1",ring1="Weatherspoon Ring",ring2="Prolix Ring",
    ...
    sets.midcast['Enhancing Magic'] = set_combine(sets.precast.FC , {ammo="Impatiens",
		head="Umuthi Hat",neck="Enhancing Torque",ear1="Estq. Earring",ear2="Loquacious Earring",body="Lethargy Sayon",hands="Atrophy Gloves +1",ring1="Weatherspoon Ring",ring2="Prolix Ring",back="Sucellos's Cape",waist="Witful Belt",legs="Lethargy Fuseau",feet="Lethargy Houseaux"})--Siegel Sash

    sets.midcast.Refresh = set_combine(sets.midcast['Enhancing Magic'], {body="Vitivation Tabard +1",back="Sucellos's Cape",legs="Lethargy Fuseau"})
	...
	sets.midcast['Bio III'] =  set_combine(sets.midcast['Enfeebling Magic'], {legs="Vitivation Tights +1"})
	
	sets.midcast['Paralyze II'] =  set_combine(sets.midcast['Enfeebling Magic'], {feet="Vitivation Boots +1"})
	
	sets.midcast['Blind II'] = set_combine(sets.midcast['Enfeebling Magic'], {legs="Vitivation Tights +1"})
