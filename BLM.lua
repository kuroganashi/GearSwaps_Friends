...
function init_gear_sets()
	...
	sets.precast.Waltz = {
		head="Nahtirah Hat",neck="Unmoving Collar",ear2="Roundel Earring",ear1="Soil Pearl",
		body="Jhakri Robe +1",hands="Jhakri Cuffs +1",ring1="Titan Ring",ring2="Titan Ring",
		back="Iximulew Cape",waist="Warwolf Belt",legs="Jhakri Slops +1",feet="Jhakri Pigaches +1"}--Lengo Pants
	
    -- Fast cast sets for spells

    sets.precast.FC = {ammo="Impatiens",
        head="Nahtirah Hat",ear1="Etiolation Earring",ear2="Loquacious Earring",neck="Voltsurge Torque",
        body="Vrikodara Jupon",ring1="Weatherspoon Ring",ring2="Prolix Ring",
		back="Ogapepo Cape",legs="Psycloth Lappas",feet="Regal Pumps +1"}--Swith Cape

    sets.precast.FC['Enhancing Magic'] = set_combine(sets.precast.FC, {waist="Siegel Sash"})

    sets.precast.FC['Elemental Magic'] = set_combine(sets.precast.FC, {neck="Incanter's Torque"})
    ...
    sets.precast.WS['Vidohunir'] = {ammo="Dosis Tathlum",
		...
		sets.precast.WS['Myrkr'] = {ammo="Plumose Sachet",
		head="Nahtirah Hat",neck="Sanctity Necklace",ear1="Gifted Earring",ear2="Evans Earring",
		body="Witching Robe",hands="Telchine Gloves",ring1="Fenrir Ring",ring2="Sangoma Ring",
		...
		head="Jhakri Coronal +1",neck="Fotia Gorget",ear1="Brutal Earring",ear2="Moonshade Earring",body="Jhakri Robe +1",hands="Jhakri Cuffs +1",ring1="Petrov Ring",ring2="Acumen Ring",back="Taranus's Cape",waist="Fotia Belt",legs="Jhakri Slops +1",feet="Jhakri Pigaches +1"}--80% INT Base
    ...
    sets.midcast.Cure = {main="Serenity",ammo="Impatiens",
		...
		body="Heka's Kalasiris",hands="Telchine Gloves",ring1="Weatherspoon Ring",ring2="Prolix Ring",
    ...
    sets.midcast['Enhancing Magic'] = {main="Serenity",
		...
		body="Vrikodara Jupon",hands="Jhakri Cuffs +1",ring1="Weatherspoon Ring",ring2="Prolix Ring",back="Ogapepo Cape",
		legs="Psycloth Lappas"}
    
    sets.midcast.Stoneskin = set_combine(sets.midcast['Enhancing Magic'], {waist="Siegel Sash",ear1="Earthcry Earring",hands="Carapacho Cuffs"})--legs="Haven Hose"

    sets.midcast['Enfeebling Magic'] = {main="Lathi",sub="Niobid Strap",ammo="Plumose Sachet",
		head="Merlinic Hood",neck="Incanter's Torque",ear1="Lifestorm Earring",ear2="Psystorm Earring",
		body="Ischemia Chasu.",hands="Jhakri Cuffs +1",ring1="Fenrir Ring",ring2="Sangoma Ring",
		back="Taranus's Cape",waist="Refoccilation Stone",legs="Merlinic Shalwar",feet="Merlinic Crackows"}
        
    sets.midcast.ElementalEnfeeble = sets.midcast['Enfeebling Magic']

    sets.midcast['Dark Magic'] = {main="Lathi",sub="Niobid Strap",ammo="Plumose Sachet",
		head="Merlinic Hood",neck="Incanter's Torque",ear1="Lifestorm Earring",ear2="Psystorm Earring",
		body="Jhakri Robe +1",hands="Jhakri Cuffs +1",ring1="Fenrir Ring",ring2="Sangoma Ring",
		back="Taranus's Cape",waist="Refoccilation Stone",legs="Merlinic Shalwar",feet="Merlinic Crackows"}

    sets.midcast.Drain = {main="Lathi",sub="Niobid Strap",ammo="Plumose Sachet",
		head="Merlinic Hood",neck="Incanter's Torque",ear1="Lifestorm Earring",ear2="Psystorm Earring",
		body="Jhakri Robe +1",hands="Jhakri Cuffs +1",ring1="Fenrir Ring",ring2="Sangoma Ring",
    ...
    sets.midcast.Stun = {main="Lathi",sub="Niobid Strap",ammo="Plumose Sachet",
		head="Nahtirah Hat",neck="Incanter's Torque",ear1="Lifestorm Earring",ear2="Psystorm Earring",
		body="Jhakri Robe +1",hands="Jhakri Cuffs +1",ring1="Fenrir Ring",ring2="Prolix Ring",
		back="Taranus's Cape",waist="Refoccilation Stone",legs="Merlinic Shalwar",feet="Merlinic Crackows"}

	sets.midcast.Death = {ammo="Plumose Sachet",
		head="Nahtirah Hat",neck="Sanctity Necklace",ear1="Gifted Earring",ear2="Evans Earring",
		body="Witching Robe",hands="Telchine Gloves",ring1="Fenrir Ring",ring2="Sangoma Ring",
		back="Pahtli Cape",waist="Fucho-No-Obi",legs="Psycloth Lappas",feet="Medium's Sabots"}	
		
    sets.midcast.BardSong = {main="Lathi",sub="Niobid Strap",ammo="Plumose Sachet",
		head="Merlinic Hood",neck="Incanter's Torque",ear1="Lifestorm Earring",ear2="Psystorm Earring",
		body="Jhakri Robe +1",hands="Jhakri Cuffs +1",ring1="Fenrir Ring",ring2="Sangoma Ring",
		back="Taranus's Cape",waist="Refoccilation Stone",legs="Merlinic Shalwar",feet="Merlinic Crackows"}
    ...
    sets.midcast['Elemental Magic'] = {main="Lathi",sub="Niobid Strap",ammo="Dosis Tathlum",
		head="Merlinic Hood",neck="Incanter's Torque",ear1="Barkarole Earring",ear2="Friomisi Earring",
    ...
    sets.midcast['Elemental Magic'].Resistant = {main="Lathi",sub="Niobid Strap",ammo="Dosis Tathlum",
		head="Merlinic Hood",neck="Incanter's Torque",ear1="Barkarole Earring",ear2="Friomisi Earring",
		body="Jhakri Robe +1",hands="Amalric Gages",ring1="Fenrir Ring",ring2="Fenrir Ring",
		back="Taranus's Cape",waist="Refoccilation Stone",legs="Merlinic Shalwar",feet="Merlinic Crackows"}--Refoccilation Stone/Merlinic Shalwar
	...
	--MP Back
	sets.midcast['Elemental Magic'].MP_Back = {main="Lathi",sub="Niobid Strap",ammo="Dosis Tathlum",
		head="Merlinic Hood",neck="Incanter's Torque",ear1="Barkarole Earring",ear2="Friomisi Earring",
		body="Spae. Coat +1",hands="Amalric Gages",ring1="Fenrir Ring",ring2="Fenrir Ring",
		back="Taranus's Cape",waist="Refoccilation Stone",legs="Merlinic Shalwar",feet="Merlinic Crackows"}
	
	sets.midcast['Elemental Magic'].HighTierNuke.MP_Back = set_combine(sets.midcast['Elemental Magic'], {
		main="Lathi",sub="Niobid Strap",ammo="Dosis Tathlum",
		head="Merlinic Hood",neck="Incanter's Torque",ear1="Barkarole Earring",ear2="Friomisi Earring",
		body="Spae. Coat +1",hands="Amalric Gages",ring1="Fenrir Ring",ring2="Fenrir Ring",
		back="Taranus's Cape",waist="Refoccilation Stone",legs="Merlinic Shalwar",feet="Merlinic Crackows"})
    ...
    sets.midcast['Elemental Magic'].Proc = {main="Lathi", sub="Niobid Strap",ammo="Impatiens",
        ...
        body="Vrikodara Jupon",hands="Serpentes Cuffs",ring1="Weatherspoon Ring",ring2="Prolix Ring",
	...
	--feet={ name="Merlinic Crackows", augments={'Mag. Acc.+22 "Mag.Atk.Bns."+22','Magic Damage +11','Mag. Acc.+14','"Mag.Atk.Bns."+3',}}
    ...
    -- Resting sets
    sets.resting = {main="Chatoyant Staff",sub="Niobid Strap",ammo="Dosis Tathlum",
    ...
    sets.idle = {main="Lathi", sub="Niobid Strap",ammo="Dosis Tathlum",
		head="Wivre Hairpin",neck="Lissome Necklace",ear1="Infused Earring",ear2="Loquacious Earring",
		body="Jhakri Robe +1",hands="Serpentes Cuffs",ring1="Matrimony Ring",ring2="Defending Ring",
		back="Umbra Cape",waist="Fucho-No-Obi",legs="Assiduity Pants +1",feet="Herald's Gaiters"}

    -- Idle mode that keeps PDT gear on, but doesn't prevent normal gear swaps for precast/etc.
    sets.idle.PDT = {main="Earth Staff", sub="Niobid Strap",ammo="Dosis Tathlum",
		head="Jhakri Coronal +1",neck="Twilight Torque",ear1="Gifted Earring",ear2="Loquacious Earring",
		body="Jhakri Robe +1",hands="Jhakri Cuffs +1",ring1="Dark Ring",ring2="Defending Ring",
    ...
    sets.idle.Weak = {main="Lathi",sub="Niobid Strap",ammo="Impatiens",
        head="Wivre Hairpin",neck="Lissome Necklace",ear1="Infused Earring",ear2="Loquacious Earring",
        body="Jhakri Robe +1",hands="Serpentes Cuffs",ring1="Dark Ring",ring2="Defending Ring",
        back="Umbra Cape",waist="Fucho-No-Obi",legs="Assiduity Pants +1",feet="Herald's Gaiters"}
    
    -- Town gear.
    sets.idle.Town = {main="Lathi",sub="Niobid Strap",ammo="Dosis Tathlum",
		head="Wivre Hairpin",neck="Lissome Necklace",ear1="Infused Earring",ear2="Loquacious Earring",
		body="Jhakri Robe +1",hands="Serpentes Cuffs",ring1="Matrimony Ring",ring2="Defending Ring",
		back="Umbra Cape",waist="Fucho-No-Obi",legs="Assiduity Pants +1",feet="Herald's Gaiters"}
    ...
    sets.defense.PDT = {main="Earth Staff",sub="Niobid Strap",
        ...
        body="Jhakri Robe +1",hands="Jhakri Cuffs +1",ring2="Dark Ring",ring1="Defending Ring",
    ...
    sets.engaged = {ammo="Amar Cluster",
		head="Merlinic Hood",ear1="Brutal Earring",ear2="Cessance Earring",neck="Lissome Necklace",
		body="Jhakri Robe +1",hands="Telchine Gloves",ring1="Petrov Ring",ring2="K'ayres Ring",
		back="Umbra Cape",waist="Cetl Belt",legs="Lengo Pants",feet="Merlinic Crackows"}

	sets.engaged.Refresh = {ammo="Dosis Tathlum",
		head="Wivre Hairpin",ear1="Brutal Earring",ear2="Cessance Earring",neck="Lissome Necklace",
