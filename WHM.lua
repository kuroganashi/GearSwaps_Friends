...
function init_gear_sets()
    ...
    sets.precast.FC = {ammo="Impatiens",
		...
		back="Ogapepo Cape",waist="Witful Belt",legs="Lengo Pants",feet="Regal Pumps +1"} --Nahtirah Hat/"Vrikodara Jupon"
    ...
    sets.midcast.FastRecast = {ammo="Impatiens",
		...
		body="Ebers Bliaud",hands="Fanatic Gloves",ring1="Weatherspoon Ring",ring2="Prolix Ring",
		back="Swith Cape",waist="Witful Belt",legs="Lengo Pants",feet="Regal Pumps +1"}--"Vrikodara Jupon"
    ...
    sets.midcast['Enhancing Magic'] = set_combine(sets.precast.FastRecast,    {main="Beneficus",ammo="Impatiens",neck="Incanter's Torque",
		hands="Fanatic Gloves",ear1="Mendi. Earring",ear2="Loquacious Earring",ring1="Weatherspoon Ring",ring2="Prolix Ring",head="Umuthi Hat",
		back="Ogapepo Cape",waist="Siegel Sash",legs="Piety Pantaloons",feet="Orison Duckbills +2"})--Ebers Duckbills
    ...
    sets.midcast.Auspice = set_combine(sets.precast.FastRecast,   {ammo="Impatiens",hands="Fanatic Gloves",ear1="Mendi. Earring",ear2="Loquacious Earring",feet="Orison Duckbills +2",
    ...
    sets.midcast.BarElement = set_combine(sets.precast.FastRecast,    {main="Beneficus",ammo="Impatiens",
		...
		back="Ogapepo Cape",waist="Siegel Sash",legs="Ebers Pantaloons",feet="Orison Duckbills +2"})

    sets.midcast.Regen = set_combine(sets.precast.Cure,    {main="Bolelabunga",ammo="Impatiens",
		body="Telchine Chas.",hands="Ebers Mitts",ear1="Mendi. Earring",ear2="Loquacious Earring",ring1="Weatherspoon Ring",ring2="Prolix Ring",head="Umuthi Hat",feet="Regal Pumps +1",
		legs="Theo. Pant. +1",waist="Witful Belt"})

    sets.midcast.Protectra = set_combine(sets.precast.FastRecast,   {ammo="Impatiens",ring1="Sheltered Ring",feet="Piety Duckbills",waist="Witful Belt",ring2="Prolix Ring",head="Umuthi Hat",
	ear2="Loquacious Earring"})
	sets.midcast.Protect = sets.midcast.Protectra
	
	sets.midcast.Shellra = set_combine(sets.precast.FastRecast,   {ammo="Impatiens",ring1="Sheltered Ring",legs="Piety Pantaloons",waist="Witful Belt",ring2="Prolix Ring",head="Umuthi Hat",
	ear2="Loquacious Earring"})
	sets.midcast.Shell = sets.midcast.Shellra

    sets.midcast['Divine Magic'] = set_combine(sets.precast.FastRecast,   {main="Rubicundity",ammo="Kalboron Stone",
    ...
    sets.midcast['Dark Magic'] = set_combine(sets.precast.FastRecast,    {main="Rubicundity",ammo="Kalboron Stone",
		head="Nahtirah Hat",neck="Incanter's Torque",ear1="Lifestorm Earring",ear2="Psystorm Earring",
	...
	sets.midcast.Drain = set_combine(sets.precast.FastRecast,    {main="Rubicundity",ammo="Kalboron Stone",
		head="Appetence Crown",neck="Incanter's Torque",ear1="Lifestorm Earring",ear2="Psystorm Earring",
    ...
    sets.midcast.MndEnfeebles = set_combine(sets.precast.FastRecast,   {main="Rubicundity",ammo="Kalboron Stone",
		head="Nahtirah Hat",neck="Incanter's Torque",ear1="Lifestorm Earring",ear2="Psystorm Earring",
		body="Ischemia Chasu.",hands="Telchine Gloves",ring1="Weatherspoon Ring",ring2="Sangoma Ring",
		back="Toro Cape",waist="Refoccilation Stone",legs="Lengo Pants",feet="Medium's Sabots"})

	sets.midcast.IntEnfeebles = set_combine(sets.precast.FastRecast,   {main="Rubicundity",ammo="Kalboron Stone",
		head="Nahtirah Hat",neck="Incanter's Torque",ear1="Lifestorm Earring",ear2="Psystorm Earring",
		body="Ischemia Chasu.",hands="Telchine Gloves",ring1="Weatherspoon Ring",ring2="Sangoma Ring",
		back="Toro Cape",waist="Refoccilation Stone",legs="Lengo Pants",feet="Medium's Sabots"})
    ...
    sets.resting = {ammo="Homiliary",
		head="Ebers Cap",neck="Twilight Torque",body="Ebers Bliaud",hands="Serpentes Cuffs",ring1="Paguroidea Ring",ring2="Defending Ring",
    ...
    sets.idle = {main="Bolelabunga",sub="Culminus",ammo="Homiliary",
		...
		body="Ebers Bliaud",hands="Serpentes Cuffs",ring1="Paguroidea Ring",ring2="Defending Ring",
